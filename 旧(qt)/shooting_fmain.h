int main(int argc, char* argv[]) {
    ...
    if (GetLastError() == ERROR_ALREADY_EXISTS) {
		...
		trayIcon.setIcon(QIcon("Shooting/trayIcon.png"));
		// アイコンをシステムトレイに表示
	...
	/* pixmap */
	sp::A_aqua = new QPixmap("Shooting/A_aqua.png");
	sp::triangle_red = new QPixmap("Shooting/triangle_red.png");
	sp::hexagon_yellow = new QPixmap("Shooting/hexagon_yellow.png");
	sp::triangle_blue = new QPixmap("Shooting/triangle_blue.png");
